...
class MBartFineTuner(pl.LightningModule):
    """
    Fine tune a pre-trained MBart model
    """

    def __init__(self, hparams, tfm_model, tokenizer):
        super(MBartFineTuner, self).__init__()
...
if args.do_train:
    ...
    tfm_model = MBartForConditionalGeneration.from_pretrained(
        args.model_name_or_path
    )
    model = MBartFineTuner(args, tfm_model, tokenizer)
...
if args.do_inference:
    ...
    # initialize the Mbart model from previous checkpoint
    ...
    tfm_model = MBartForConditionalGeneration.from_pretrained(args.output_dir)
