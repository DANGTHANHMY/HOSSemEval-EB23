...
class MvpFineTuner(pl.LightningModule):
    """
    Fine tune a pre-trained Bart model
    """

    def __init__(self, hparams, tfm_model, tokenizer):
        super(MvpFineTuner, self).__init__()
...
if args.do_train:
    ...
    tfm_model = MvpForConditionalGeneration.from_pretrained(
        args.model_name_or_path
    )
    model = MvpFineTuner(args, tfm_model, tokenizer)
...
if args.do_inference:
    ...
    # initialize the Bart model from previous checkpoint
